...
PINODE head = NULL;  // Global Variabe , extern strorage class
...
void man(char *name)
{
    ...
    {
        printf("Desrciption : Used to delete the file\n");
        printf("Usage : rm File_Name\n");
    }
    else
    {
        printf("ERRORR : No manual entry avaiable.\n");
    }
}
...
void Displayhelp()
{
    ...
    printf("fstat : To Display inforamation of file using file descriptor\n");
...
int main()
{
    ...
    else if(count==2)
    {
        if(strcmp(command[0],"stat")==0)
        {
            ...
            if(ret == -1)
            printf("ERROR: Incorrext parameters\n");
            if(ret==-2)
    ...
    {
        if(strcmp(command[0],"create")==0) //Error code handling
        {
